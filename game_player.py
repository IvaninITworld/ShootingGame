...
class Flight(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.images = \
            [pygame.image.load(img_dir + "/images/flight_C.png")
           , pygame.image.load(img_dir + "/images/flight_L.png")
           , pygame.image.load(img_dir + "/images/flight_LL.png")
           , pygame.image.load(img_dir + "/images/flight_R.png")
           , pygame.image.load(img_dir + "/images/flight_RR.png")]
